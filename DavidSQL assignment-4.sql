use techbros;
create table FSWRRV(ID int not null, Sname varchar(255) not null, Age int not null, Gender varchar(10) not null, Slevel varchar(25) not null, Phonenumber varchar(45) not null, YOE varchar(45) not null, Location varchar(255) not null);
insert into FSWRRV(ID,Sname,Age,Gender,Slevel,Phonenumber,YOE,Location)values
